# PlayLoom/utils/render_template.py
...
from PlayLoom.server.exceptions import InvalidHash
from PlayLoom.utils.file_properties import get_fname, get_uniqid
...
template_env = Environment(
    loader=FileSystemLoader('PlayLoom/template'),
    enable_async=True,
    cache_size=200,
    auto_reload=False,
    optimized=True
